...
hi MarkWord1   guibg=LightRed      guifg=Black
hi MarkWord2   guibg=LightGreen    guifg=Black
hi MarkWord3   guibg=LightBlue     guifg=Black
hi MarkWord4   guibg=LightCyan     guifg=Black
hi MarkWord5   guibg=LightMagenta  guifg=Black
hi MarkWord6   guibg=LightYellow   guifg=Black
hi MarkWord7   guibg=LightGray     guifg=Black
hi MarkWord8   guibg=White         guifg=Black
hi MarkWord9   guibg=Purple        guifg=Black
hi MarkWord10  guibg=Red           guifg=Black
hi MarkWord11  guibg=Green         guifg=Black
hi MarkWord12  guibg=Cyan          guifg=Black
hi MarkWord13  guibg=Magenta       guifg=Black
hi MarkWord14  guibg=Yellow        guifg=Black
hi MarkWord15  guibg=Gray          guifg=Black
hi MarkWord16  guibg=Orange        guifg=Black
hi MarkWord17  guibg=Brown         guifg=Black
hi MarkWord18  guibg=Violet        guifg=Black
hi MarkWord19  guibg=DarkCyan      guifg=Black
hi MarkWord20  guibg=SeaGreen      guifg=Black

" Anti reinclusion guardsBlack	
